...
def load_checkpoint(fpath):
    ...
    try:
        ...
        # PyTorch 2.6+ defaults to weights_only=True. Our internal training
        # checkpoints also store optimizer/scheduler objects, so we fall back
        # to the old behavior for trusted local checkpoints.
        ...
        try:
            ...
            checkpoint = _torch_load(weights_only=False, pickle_module=pickle)
