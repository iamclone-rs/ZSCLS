...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.HICROPL.USE_TEMPLATE_MCC = False
    cfg.TRAINER.HICROPL.TEMPLATE_MCC_WEIGHT = 0.1
    cfg.TRAINER.HICROPL.TEMPLATE_TOPK = 2
    cfg.TRAINER.HICROPL.TEMPLATE_NUM = 8
    cfg.TRAINER.HICROPL.TEMPLATE_LOGIT_ALPHA = 0.2
    cfg.DATASET.SUBSAMPLE_CLASSES = "all"  # all, base or new
