...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.HICROPL.USE_SEMANTIC_BANK = True
    cfg.TRAINER.HICROPL.SEMANTIC_BANK_ALPHA = 0.35
    cfg.TRAINER.HICROPL.SEMANTIC_BANK_MAX_PROMPTS = 16
    cfg.TRAINER.HICROPL.SEMANTIC_BANK_TEMPERATURE = 0.07
    cfg.DATASET.SUBSAMPLE_CLASSES = "all"  # all, base or new
